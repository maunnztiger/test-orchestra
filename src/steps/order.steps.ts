...
UND('an dem Symbol für seinen Warenkorb ist eine kleine 1 angezeigt', async(world: CustomWorld)=> {})
...
UND('es ist ein Button {string} auf der rechten Seite der Bestellung', async(world: CustomWorld)=> {}) 
...
WENN('der User mit dme Button "Continue Shopping" zur Produktliste zurückkehrt', async(world: CustomWorld)=> {}) 
DANN('erscheint die Liste der Produkte wie oben im Filter eingestellt', async(world: CustomWorld)=> {}) 
