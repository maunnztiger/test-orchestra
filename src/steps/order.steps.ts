...
DANN("öffnet sich eine Detailansicht des Produkts", async function (this: CustomWorld) {});

WENN("der User nun auf den Button {string} klickt", async function (this: CustomWorld) {});
DANN("landet das Produkt in seinem Warenkorb", async function (this: CustomWorld) {});
UND(
...
WENN(
  "der User auf den kleinen Einkaufswagen mit der 1 klickt",
  async function (this: CustomWorld) {}
);
DANN(
  "erscheint eine Einzelansicht der aktuellen Bestellung",
  async function (this: CustomWorld) {}
);
UND(
...
UND(
  "es ist ein grüner Button {string} auf der rechten Seite",
  async function (this: CustomWorld) {}
);
UND(
...
WENN("der User auf den Button {string} klickt", async function (this: CustomWorld) {});
DANN(
  "verschwindet das vorher angezeigte Objekt der Bestellung aus der Anzeige",
  async function (this: CustomWorld) {}
);
UND(
  "die kleine 1 am Warenkorb-Symbol rechts oben verschwindet",
  async function (this: CustomWorld) {}
);
...
UND("der Warenkorb ist wieder leer", async function (this: CustomWorld) {});
